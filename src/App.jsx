  ...
  function buildPdfHtml(mode) {
    ...
    const css = `
      ...
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .doc-header img { width: 60px; height: 60px; border-radius: 50%; margin-bottom: 6px; }
      .doc-header h1 { font-size: 14pt; font-weight: 700; color: #222; margin-bottom: 2px; }
      .doc-header .addr { font-size: 9pt; color: #555; margin-bottom: 2px; }
      .doc-header .subtitle { font-size: 11pt; font-weight: 700; color: #222; margin-top: 2px; }
      ...
      body = `
        <div class="page">
          <div class="doc-header">
            <img src="${LOGO_SRC}" alt="GMCFI" /><h1>Grace Montagnard Alliance Church Finland</h1>
              ...
              <table>
                ...
                <tfoot>
                  <tr style={{ borderTop: "2px solid rgba(255,255,255,0.08)" }}>
                    ...
                    <td style={{ textAlign: "right", color: "#5dda8a", fontFamily: "'DM Mono', monospace", fontWeight: 700 }}>{fmtAbs(totalIncome)}</td>
                    <td style={{ textAlign: "right", color: "#ff6b6b", fontFamily: "'DM Mono', monospace", fontWeight: 700 }}>{fmtAbs(totalExpense)}</td>
